...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-5 min-h-[80vh] border-t'>
      ...
      <input required onChange={onChangeHandler} name='deliveryAddress' value={formData.deliveryAddress} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Delivery Address'></input>
      <div className='flex gap-3'>
      ...
      <input required onChange={onChangeHandler} name='phone' value={formData.phone} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Phone number'></input>
      </div>
